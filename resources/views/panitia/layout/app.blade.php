        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.html" class="site_title"><i class="fa fa-paw"></i> <span>Panitia PSB</span></a>
            </div>
            ...
            <div class="profile clearfix">
              <div class="profile_pic">
                <img src="{{ asset('adminassets') }}/images/img.jpg" alt="{{ asset('adminassets') }}." class="img-circle profile_img">
              </div>
                  ...
                  <ul class="dropdown-menu list-unstyled msg_list" role="menu" aria-labelledby="navbarDropdown1">
                    <li class="nav-item">
                      <a class="dropdown-item">
                        ...
                        <span class="message">
                          Film festivals used to be do-or-die moments for movie makers. They were where{{ asset('adminassets') }}.
                        </span>
                      </a>
                    </li>
                    <li class="nav-item">
   ...
   <!-- start of weather widget -->
        ...
        <footer>
          <div class="pull-right">
            Gentelella - Bootstrap adminassets Template by <a href="https://colorlib.com">Colorlib</a>
          </div>
          <div class="clearfix"></div>
        </footer>
        <!-- /footer content -->
