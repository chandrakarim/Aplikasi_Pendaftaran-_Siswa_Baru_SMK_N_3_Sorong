                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    <form  action="{{ route('panitia.pengumuman.update',['id' => $pengumuman[0]->id]) }}" method="POST"  enctype="multipart/form-data">
                                        ...
                                        <div class="field item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                <input class="form-control"  name="kode_pgn" value="{{$pengumuman[0]->kode_pgn}}"   readonly />
                                            </div>
                                        </div>
                                        ...
                                        <div class="field item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                <input class="form-control" data-validate-length-range="6" data-validate-words="2" name="judul_pengumuman"  value="{{$pengumuman[0]->judul_pengumuman}}" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="field item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                <input class="form-control" data-validate-length-range="6" data-validate-words="2" name="deskripsi" value="{{$pengumuman[0]->deskripsi}}" />
                                            </div>
                                        </div>
                                        <div class="field item form-group">
                                            ...
                                            <option selected value="{{$pengumuman[0]->status}}">{{$pengumuman[0]->status}}</option>
